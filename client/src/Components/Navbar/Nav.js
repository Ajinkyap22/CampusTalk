  ...
  return (
    <nav className="sticky top-0 z-30 w-full flex bg-white dark:bg-darkSecondary pt-2 2xl:pt-3.5 shadow-md justify-between md:justify-around items-center">
      ...
      <div className="flex items-center dropDownToggle">
        {/* notifications */}
        <button className="w-5 2xl:w-7 h-auto" onClick={toggleNotifications}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="fill-[#818181] dark:fill-gray-300 dropDownToggle"
            viewBox="0 0 16 16"
          >
        ...
        >
          ...
          {user && user.picture ? (
            <img
              ...
              alt=""
              className="rounded-full inline h-6 2xl:h-9 w-auto ml-1 dropDownToggle"
            />
          ) : (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="inline ml-2 mr-1 align-middle dropDownToggle w-5 2xl:w-7 fill-[#818181] dark:fill-gray-300"
              viewBox="0 0 16 16"
            >
