...
function MobileActions() {
  ...
  return (
    <div className="relative lg:hidden">
      <button
        className="fixed right-4 bottom-5 z-20 dropDownToggle"
      ...
      {showActions && (
        ...
        >
          <ul>
            {/* create post*/}
            <li className="p-1 text-mxs before:dark:text-darkLight">
              <Link to={`/create-post`}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="inline mr-1 mb-0.52 w-3.5 fill-[#818181] dark:fill-darkLight"
                  viewBox="0 0 16 16"
                >
            ...
            <li className="p-1 text-mxs before:dark:text-darkLight">
              <Link to={`/create-event`}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="inline mr-1 mb-0.52 w-3 h-5 fill-[#818181] dark:fill-darkLight"
                  viewBox="0 0 16 16"
                >
