...
function FAQ({ faqData }) {
  ...
  return (
    <div className="hidden lg:block sticky top-[5.5rem] bg-white dark:bg-darkSecondary shadow-base text-[#000000e6] my-8 lg:w-[14rem] lg-max-w-[14rem] xl:w-[17rem] xl:max-w-[17rem] 2xl:w-[24rem] 2xl:max-w-[24rem] 3xl:w-[28rem] 3xl:max-w-[28rem] rounded self-start">
      {/* title */}
