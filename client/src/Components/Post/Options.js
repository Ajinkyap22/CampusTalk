  ...
  return (
    ...
    >
      <ul>
        {/* edit post */}
        <li
          className="lg:p-1 xl:p-1.5 lg:text-mxs xl:text-sm 2xl:text-base dark:text-darkLight"
          hidden={!isAuthor}
        >
          <Link to={`/forums/${forum._id}/posts/${postId}/edit-post`}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="inline mr-2 lg:w-3 xl:w-4 2xl:w-5  fill-[#818181] dark:fill-darkLight"
              viewBox="0 0 16 16"
            >
