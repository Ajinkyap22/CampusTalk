...
function Confirm({ title, history }) {
  ...
  return (
    <main className="w-full bg-bubble flex relative h-full overflow-auto flex-col items-center">
      ...
      <section className="text-center bg-white rounded p-3 py-4 shadow-base w-[90%] md:w-2/3 lg:w-[30%] 2xl:w-[25%]">
        <h1 className="text-lg md:text-xl lg:text-2xl text-primary mt-2">
          Account Confirmed
        </h1>
